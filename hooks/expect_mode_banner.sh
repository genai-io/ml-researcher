#!/usr/bin/env bash
# Surface a banner when .mlr-expect-mode exists at project root.
#
# Why a hook (vs letting the agent read the marker file): expect mode flips
